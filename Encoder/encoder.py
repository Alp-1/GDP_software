...
class Encoder(object):
    ...
    def __init__(self, A, B,pulses_per_revolution):
        ...
        self.pules_per_revolution = pulses_per_revolution
    ...
    def calculate_rps(self):
        ...
        measurement_time = current_time - self.prev_time
        if measurement_time == 0:
            return 0.0  
        rps = (self.pos - self.prev_pos) / measurement_time / self.pulses_per_revolution
